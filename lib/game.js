...
var questions = {
	'area1' : [
		{
			...
			'options' : [
				{
					'option' : '1. I think of this as a lesson and realize that when I gain more experience, there will not be any more situations like this.', 
					'score' : 0, 
					'response' : 'You shouldn’t ignore this situation. Our value is open communication.'
				}, 
				{
					'option' : '2. I ask my manager not to invite me to the meetings with this client for now.', 
					'score' : -200, 
					'response' : 'Problems in the company should not be ignored, they should be solved.'
				}, 
				{
					'option' : '3. I openly tell my manager that I felt very uncomfortable and suggest that next time we should discuss such meetings beforehand.', 
					'score' : +500, 
					'response' : 'Open and constructive communication is the best solution.'
				}, 
				{
					'option' : '4. I sign up my manager to a comedy club without him knowing.', 
					'score' : -500, 
					'response' : 'Will revenge change anything?'
				}, 
				{
					'option' : '5. After this meeting, I suggest to make the presentation for the next meeting myself.', 
					'score' : +300, 
					'response' : 'That’s a good idea but your manager should know about the issue so the same things doesn’t happen again.'
				}, 
				{
					'option' : '6. After the meeting, I go back to my office and tell my colleagues about what happened. Everybody laughs.', 
					'score' : -400, 
		...
		}, 
		{
			...
			'options' : [
				{
					'option' : '1. Next time I see my manager, I tell him about the noisy work environment and ask him for advice.', 
					'score' : +250, 
				...
				{
					'option' : '2. I buy noise-cancelling headphones and continue working.', 
					'score' : +150, 
					'response' : 'Sometimes it’s best to start with yourself.'
				}, 
				{
					'option' : '3. I meet some friends on the weekend and discuss this with them – maybe they’ll have some ideas.', 
					'score' : -200, 
					'response' : 'It’s not the best idea to share such problems with people who are uninvolved in the situation.'
				}, 
				{
					'option' : '4. I invite both colleagues to lunch and suggest a game “Meeting in an open space = free lunch for your colleagues“.', 
					'score' : +500, 
					'response' : 'Given the situation, this is the best solution.'
				}, 
				{
					'option' : '5. I also start speaking with clients in the open space, hoping that my other colleagues will take the hint.', 
					'score' : -500, 
					'response' : 'This might only make things worse.'
				}, 
				{
					'option' : '6. I make a ball of paper and throw it at a noisy colleague.', 
					'score' : -100, 
		...
		}, 
		{
			...
			'options' : [
				{
					'option' : '1. I send an e-mail to the project manager with my understanding of the situation, the possible risks and solutions.', 
					'score' : +500, 
				...
				{
					'option' : '2. I invite the project manager to eat a kebab after work and let him know that I am there to help if he faces any difficulties. ', 
					'score' : +400, 
					'response' : ' Great idea! But letting someone know you will help is not the same as constructive feedback.'
				}, 
				{
					'option' : '3. I talk to the department manager about this project manager‘s abilities. ', 
					'score' : +50, 
					'response' : 'It‘s good that you‘re taking initiative to solve problems but it would be better to talk to the project manager.'
				}, 
				{
					'option' : '4. I inform the project manager that I want to work on a different project.', 
					'score' : -100, 
					'response' : 'It‘s fine to make a decision but you‘re thinking only about yourself. '
				}, 
				{
					'option' : '5. During coffee break, I talk to my colleagues from another project about the problems I‘m facing and ask what they think about it. ', 
					'score' : -300, 
					'response' : 'This is not constructive communication, it is gossip. '
				}, 
				{
					'option' : '6. I don’t go into project management specifics, that’s not my responsibility. I do the work that I think needs to be done to finish the project.', 
					'score' : -500, 
		...
		}, 
		{
			...
			'options' : [
				{
					'option' : '1. You are a new team member, so you try to adjust.', 
					'score' : -100, 
					'response' : 'You should be proactive, not passive.'
				}, 
				{
					'option' : '2. I organize team meetings about best practices. ', 
					'score' : +300, 
					'response' : 'Maybe you will engage the whole team but they might resist the changes.'
				}, 
				{
					'option' : '3. I use my own methods and hope that with time they will stick. ', 
					'score' : +100, 
					'response' : 'It’s hard to achieve things alone.'
				}, 
				{
					'option' : '4. I share my ideas next time I speak to the manager. ', 
					'score' : +500, 
					'response' : 'If you get your manager’s support, it is more likely that the team will become less resistant to change.'
				}, 
				{
					'option' : '5. I print out some pictures with motivational quotes about change.', 
					'score' : -200, 
					'response' : 'You should save paper. The trees will thank you.'
				}, 
				{
					'option' : '6. I cannot deal with such work order so I send my CV to another company.', 
					'score' : -500, 
		...
		}, 
		{
			...
			'options' : [
				{
					'option' : '1. I browse CGI Intranet and try to find out what kind of goals would a person in my position have.', 
					'score' : +100, 
					'response' : 'You can find a lot of useful information on CGI Intranet, but you should coordinate your goals with you manager.'
				}, 
				{
					'option' : '2. I write my own goals and send them to my manager for approval. ', 
					'score' : +400, 
					'response' : 'It’s great that you are showing initiative but a mentor should be the person to help you in this situation. '
				}, 
				{
					'option' : '3. Maybe my manager is in a bad mood today – I’ll try again tomorrow.', 
					'score' : 0, 
					'response' : 'You will get an answer if you are not afraid to ask.'
				}, 
				{
					'option' : '4. I ask my mentor to help me set goals. ', 
					'score' : +500, 
				...
				{
					'option' : '5. If the manager says so, then it must be true. I try to form relationships with my colleagues because my performance will be based on their feedback.', 
					'score' : -200, 
					'response' : 'It’s good to form relationships with your colleagues but you have to set goals for yourself.'
				}, 
				{
					'option' : '6. I realize that I will not get along with my boss as I am a fan of another basketball team. ', 
					'score' : -500, 
		...
		}, 
		{
			...
			'options' : [
				{
					'option' : '1. You don‘t have a discussion, you just form a team that will work on that project.', 
					'score' : -200, 
					'response' : 'There is a risk that the employees will also make their own decisions without further discussion.'
				}, 
				{
					'option' : '2. I honestly tell my employees that this project will have challenges.', 
					'score' : +500, 
					'response' : 'Great! You are lowering the risks by talking about the actual situation of this project.'
				}, 
				{
					'option' : '3. I remind my employees that they are paid for a reason and ask them to work on this project for at least half a year.', 
					'score' : -100, 
				...
				{
					'option' : '4. I assemble the team out of new employees that don‘t know anything about this client.', 
					'score' : -500, 
					'response' : 'Will this choice bring you profit? You don‘t care about the satisfaction of the client.'
				}, 
				{
					'option' : '5. I invite the old employees to individual conversations to tell them not to demotivate the team.', 
					'score' : +400, 
					'response' : 'Good choice but it would also be good to talk to the whole team, not with the old employees only.'
				}, 
				{
					'option' : '6. I promise that good results will be generously rewarded.', 
					'score' : 0, 
		...
		{
			'question' : 'You are a programmer and you have been working in the company for a long time now. Because of the heavy workload, Simon, a longtime and unmotivated employee, has been added to your team. He usually doesn’t have a lot of tasks due to lack of competencies. You have to redo his assignments because the quality of the work is poor. The manager is aware of the employee\'s lack of competencies, but takes no action. What are your actions?', 
			'options' : [
				{
					'option' : '1. I share my workload with my colleagues working on the same project so that I would have time to correct Simon’s mistakes.', 
					'score' : -50, 
				...
				{
					'option' : '2. I approach HR and explain this problem.', 
					'score' : +200, 
					'response' : 'It‘s good that you‘re still looking for help even when you manager is indifferent.'
				}, 
				{
					'option' : '3. I accept this situation and do all the work myself because I do not have time to explain the problem to the manager.', 
					'score' : -500, 
					'response' : 'Bad idea. You can‘t do everything yourself and there could be several “Simons“ in the next project.'
				}, 
				{
					'option' : '4. I initiate a conversation with Simon about the current situation in the team and his contribution to the project.', 
					'score' : +500, 
					'response' : 'It‘s very good that you are taking initiative.'
				}, 
				{
					'option' : '5. I request to add another person to the team or be reassigned to another project myself because we will not be able to finish the tasks with the assigned colleague.', 
					'score' : -250, 
					'response' : 'It would be better if you spoke to Simon about how to improve his work quality and not ran away from problems.'
				}, 
				{
					'option' : '6. I give updates to the project manager everyday about our finished/unfinished tasks.', 
					'score' : +50, 
		...
		}, 
		{
			...
			'options' : [
				{
					'option' : '1. I organize a meeting with Danute and Aloyzas to find the reasons of the conflict and to try to find a compromise.', 
					'score' : +350, 
					'response' : 'We value open discussion. We should also hear Aloyzas out.'
				}, 
				{
					'option' : '2. I organize a training on conflict resolution for the project team.', 
					'score' : +50, 
				...
				{
					'option' : '3. I ask Aloyzas to come and try to find out what happened.', 
					'score' : +500, 
					'response' : 'That‘s great, first of all, we are trying to hear out both sides of the conflict.'
				}, 
				{
					'option' : '4. I listen to Danute‘s story and agree that it is a problem, but as soon as she leaves, I get back to my work.', 
					'score' : -400, 
					'response' : 'As department manager, you should respect your colleagues and not ignore their needs.'
				}, 
				{
					'option' : '5. As it is their personal problem, I buy a coupon for a dinner for the two best employees of the project.', 
					'score' : -500, 
					'response' : 'Are you sure that these colleagues who cannot get along will really take your offer to meet after work?'
				}, 
				{
					'option' : '6. I leave Danute and Aloyzas on the same project and ask the project manager to give tasks in such a way that would ensure minimal communication between them.', 
					'score' : -100, 
		...
		}, 
		{
			...
			'options' : [
				{
					'option' : '1. I decide to fire Nojus and start training new employees.', 
					'score' : +400, 
					'response' : 'People who aren‘t respectful cannot work in our company but maybe you should give Nojus a last chance.'
				}, 
				{
					'option' : '2. I invite Nojus to speak in an informal environment as a friend because everybody has feelings.', 
					'score' : +500, 
					'response' : 'Great! You should try to find out the reasons for this behavior. Openness is our value.'
				}, 
				{
					'option' : '3. I find new interns every year hoping that someone will finally get along with Nojus.', 
					'score' : -300, 
					'response' : 'And how long will that take?'
				}, 
				{
					'option' : '4. I ask my manager for help because I don‘t know what to do anymore.', 
					'score' : +100, 
					'response' : 'It‘s okay to ask for advice but you are also a manager and you need to make decisions.'
				}, 
				{
					'option' : '5. Because we need this specialist, I try to fulfill all of Nojus‘ needs.', 
					'score' : -500, 
					'response' : 'Nojus is not the team and you need a whole team.'
				}, 
				{
					'option' : '6. I talk to the employees working with Nojus and suggest that they should find common ground with Nojus themselves.', 
					'score' : -400, 
		...
		}, 
		{
			...
			'options' : [
				{
					'option' : '1. I talk to my department‘s manager and ask them to solve this issue.', 
					'score' : +250, 
					'response' : 'Good choice, but maybe you should talk to your project manager first.'
				}, 
				{
					'option' : '2. I do as much as I can during my 8 work hours.', 
					'score' : -400, 
				...
				{
					'option' : '3. I drop my current work and start doing the assignment my PM gave me, because the client really needs this.', 
					'score' : -500, 
					'response' : 'We should solve the time management problem so that we avoid similar situations in the future.'
				}, 
				{
					'option' : '4. I talk to my PM, I explain the issue and try to negotiate a bonus.', 
					'score' : +500, 
					'response' : 'Great! Our value “Partnership and Quality“ promotes open communication.'
				}, 
				{
					'option' : '5. I ask other colleagues who have worked with this PM, how they prioritize their work.', 
					'score' : -100, 
				...
				{
					'option' : '6. I suggest organizing a training on time management.', 
					'score' : +50, 
	...
	'area2' : [
		{
			'question' : 'When CGI was established?', 
			'options' : [
				{
					'option' : '1. 1976', 
					'score' : 100
		...
		{
			'question' : 'What is CGI training model?', 
			'options' : [
				{
					'option' : '1. 70-20-10', 
					'score' : 100
		...
		}, 
		{
			...
			'options' : [
				{
					'option' : '1. Member Application Platform', 
					'score' : 0
				}, 
				{
					'option' : '2. Mailbox Account Privacy', 
					'score' : 0
				}, 
				{
					'option' : '3. Member Assistance Program', 
					'score' : 100
				}
			]
		}, 
		...
		}, 
		{
			...
			'options' : [
				{
					'option' : '1. Training portal', 
					'score' : 100
				}, 
				{
					'option' : '2. Data base about CGI', 
					'score' : 0
				}, 
				{
					'option' : '3. Data base for health care insurance', 
					'score' : 0
				}
			]
		}, 
		{
			...
			'options' : [
				{
					'option' : '1. Heikki Nikku', 
					'score' : 0
				}, 
				{
					'option' : '2. Bartlomiej Niescierowicz', 
					'score' : 0
				}, 
				{
					'option' : '3. Leena-Mari Lähteenmaa', 
					'score' : 100
				}
			]
		}
...
var area3 = {
	'risk' : [
		{
			'text' : 'I came to work, but left my PC at home.', 
			'score' : 0
		}, 
		{
			'text' : 'I have oversleeped the meeting organized by me.', 
			'score' : 0
		}, 
		{
		...
		{
			'text' : 'Today wanted to work from home, but couldn‘t conncet VPN.', 
			'score' : 0
		}, 
		{
			'text' : 'I‘ve made a cup of coffee, but milk is over, though I‘m vanishing from kitchen.', 
			'score' : 0
		}, 
		{
			'text' : 'I do like cold, during summer – air conditionaire, winter - open window. Colleagues will survive', 
			'score' : 0
		}, 
		{
			'text' : 'Most favorite eating place is my working table and the most tasty dish - fish.', 
			'score' : 0
		}, 
		{
	...
	'oportunity' : [
		...
		{
			'text' : 'Managing director is on holidays, have parked my car in his place.', 
			'score' : +200
		}, 
		{
		...
		{
			'text' : 'Internet was missing. Finaly connected with the newhires.', 
			'score' : +200
		}, 
		{
			'text' : 'Have found confidential document in the printer, and destroyed it.', 
			'score' : +200
		}, 
		{
		...
		{
			'text' : 'Have hired the specialist we have been looking for a while.', 
			'score' : +200
		}, 
		{
...
function searchTeamByUser(userName, userSurname, index)
{
	for (var i = 0; i < rooms[index]['teams'].length; i++)
	{
		for (var j = 0; j < rooms[index]['teams'][i]['users'].length; j++)
		{
	      if ((rooms[index]['teams'][i]['users'][j]['userName'] == userName) && 
	      	(rooms[index]['teams'][i]['users'][j]['userSurname'] == userSurname))
	      {
	      	return i;
	      }
	    }
