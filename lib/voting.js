...
{console.log(game.teams);
  var vote = false;
  var teamIndex = game.searchTeamByTeamName(data['teamName'], game.teams);console.log(game.teams.length, teamIndex);console.log(game.teams[teamIndex]);console.log(game.teams);console.log('--------------');
  if (teamIndex != -1)
  {
          ...
          for (var j = 0; j < game.teams[teamIndex]['users'].length; j++)
          {
            ...
            {//Pendiente evitar que se reinicien las preguntas luego de elejir a otro lider porque el anterior se desconectó.
              ...
              if (data['status'] == 'starting')//Pendiente ver si está bien.
              {
                ...
                data['lastArea'] = game.teams[teamIndex]['lastArea'];
