  ...
  if (game.usersIds && (game.usersIds.indexOf(socket.id) != -1))
  {
    ...
    if (teamIndex != -1)
    {
      ...
      else
      {
        ...
        {console.log('disconnections.js, line 90: game.teams[teamIndex][\'status\'] == ' + game.teams[teamIndex]['status']);//'answeringQuestionArea1';
...
área 1 con respuestas de u1 y u2
  se desconecta u3 (disconnections.js, line 90: game.teams[teamIndex]['status'] == starting - userDisconnected)
*/